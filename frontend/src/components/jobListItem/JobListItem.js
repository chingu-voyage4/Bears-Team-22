  ...
  return (
    <article className="job-item">
      <img
        ...
        src={placeholderImg}
        alt="Computer cellphone coffee at a desk"
      />
      <div className="job-item__body">
        <h3 className="job-item__title"> Backend Software Engineer</h3>
        <p className="job-item__location">
          {' '}
          At <span className="job-item__company">Uber,</span> Arrhus, Denmark
        </p>
        ...
        <div className="job-item__action">
          ...
          <button className="job-item__save">
            Save <i className="material-icons">bookmark_border</i>
          </button>
        </div>
      </div>
    </article>
